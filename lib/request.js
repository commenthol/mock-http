...
function Request(options) {
	...
	options.rawHeaders = options.headers || {};
	options.headers = {};

	for (var p in options.rawHeaders) {
		options.headers[p.toLowerCase()] = options.rawHeaders[p];
	}
	...
	assign(this,
		...
		pick(options, 'url,method,headers,rawHeaders,trailers')
	);
